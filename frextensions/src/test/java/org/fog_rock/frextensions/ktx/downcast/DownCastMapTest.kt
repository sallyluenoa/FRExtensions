...
class DownCastMapTest {
     ...
     */
    @Test
    fun downCastMap_missTypedValue() {
        val obj: Any = mapOf(
            "Hello" to 1,
            "World" to 2,
            "!" to 3,
     ...
     */
    @Test
    fun downCastMap_missTypedKeyValue() {
        val obj: Any = mapOf(
            1 to 1,
            2 to 2,
            3 to 3,
     ...
     */
    @Test
    fun downCastMap_mixTypedKeyValue() {
        val obj: Any = mapOf(
            "Hello" to "Hello",
            "World" to "World",
            1 to 1,
